...
const Page = () => {
  ...
  const [cars, setCars] = useState(car.images?.[0]||car5)
    ...
    <div className='bg-[hsl(220,40%,89%)] mt-0.5'>
        ...
        <div className="bg-white lg:flex">
           ...
           <div className="flex justify-center -mt-6 ">
            <Image src={cars} alt="" width={300} height={300} className=" mt-4 lg:h-80 lg:w-160 xl:h-100 sm:w-200 sm:h-100  rounded-2xl w-full p-3"/>
          </div>
          ...
          <div className="grid justify-center">
            ...
            <div className="grid grid-cols-3 gap-3  p-3 justify-center max-sm:mt-4 ">
              <Image src={car.images?.[0] || car5} alt="" width={90} height={90} className="max-sm: rounded-md sm:w-55 sm:h-30 h-18 max-sm:w-ful" onClick={()=>setCars(car.images?.[0] || car5)}/>
              <Image src={car.images?.[1] || v2} alt="" width={80} height={80} className="  rounded-md sm:w-50 h-18 sm:h-30 max-sm:w-ful" onClick={()=>setCars(car.images?.[1] || v2)}/>
